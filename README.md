...
### 4. 출석체크 
- [x] 출석체크 UI 구현하기
- [ ] 출석체크 시 서버에 사용자가 접속 중인지 확인하기
- [ ] 사용자가 오프라인일 경우 `온라인 상태에서 사용해주세요.` 경고문 출력
- [ ] 사용자가 온라인일 경우 서버 API를 통해 아이템 지급 요청 보냄
- [ ] 지급 성공 후 `지급이 완료되었습니다.` 알림창 출력
- [ ] 출석체크 한 날짜와 UUID를 파이어베이스에 저장
- [ ] 출석체크 완료한 날의 경우 출석체크 완료 UI 출력